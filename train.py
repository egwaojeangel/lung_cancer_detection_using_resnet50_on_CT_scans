...
# Balance by taking min of both classes (860)
min_count = min(non_cancerous_total, cancerous_total)  # 860
random.shuffle(cancerous_files)
cancerous_files = cancerous_files[:min_count]  # Reduce cancerous from 922 to 860
